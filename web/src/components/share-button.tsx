...
export function ShareButton({ menuPlacement = 'bottom' }: ShareButtonProps) {
  ...
  const menuPosition = menuPlacement === 'top' ? 'bottom-full left-0 mb-2' : 'right-0 top-full mt-2'
      ...
      {open && (
        ...
        >
          <div className="mb-3 flex items-center justify-between">
            <p className="text-xs font-semibold uppercase tracking-wider text-[hsl(var(--primary))]">Share your demo</p>
            <button
              type="button"
